...
export class ViewProductComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute , private carrito: CarritoService, private formgroup: FormBuilder) { 
    this.productId = '';
    this.cantidad = 0;
  ...
  get valor() {    
    return this.productForm.get('valor')?.value;
  }
  ngOnInit(): void {
    this.productId = this.route.snapshot.paramMap.get('id');
  }

  addCarrito(id:string,cantidad:number){
    console.log(id,cantidad);
    
    this.carrito.addProduct(id,cantidad);
  }
  listProducts = [
    {
      id: '1',
